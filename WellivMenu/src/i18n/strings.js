...
export const strings = {
  ko: {
    ...
    retry: "다시 시도",
    noData: "등록된 메뉴가 없어요.",
    notUpdated: "식단표가 아직 갱신되지 않았어요.",
    updateSchedule: "매일 자정 12:00, 새벽 05:30 (KST) 갱신",
    today: "오늘",
    updatedAt: "업데이트",
    refresh: "새로고침",
  ...
  en: {
    ...
    notUpdated: "The menu hasn't been updated yet.",
    updateSchedule: "Updated daily at midnight 12:00 and 05:30 AM (KST)",
    today: "Today",
    updatedAt: "Updated",
    refresh: "Refresh",
  ...
  uz: {
    ...
    notUpdated: "Menyu hali yangilanmagan.",
    updateSchedule: "Har kuni yarim tun 12:00 va tonggi 05:30 (KST) da yangilanadi",
    today: "Bugun",
